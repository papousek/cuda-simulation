...
public class CudaSimulationLauncherTest {
    ...
    public void simpleTest() {
        ...
        SimulationResult result = launcher.launch(0, (float) 0.1, 1, new float[]{(float) 1.0}, (float) 0.1, 100);
...
//            assertEquals((float) (0.1 * i + 0.1), result.getSimulation(0).getPoint(i).getTime(), (float) 0.01);
        }
    }
}
